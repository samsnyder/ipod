...
object Hash58 {
  ...
  def createKey(guid: String) = {
    val id = (0 until 16 by 2).map(
      i => Integer.parseInt(guid.substring(i, i + 2), 16))

    val y: Array[Int] = new Array(16)
  ...
  def conva(n: Int): Byte = n.asInstanceOf[Byte]
