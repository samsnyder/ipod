...
case class LoadedImage(dbid: String, sourceSize: Int, id: Int,
                       rating: Int, subImages: Array[SubImage]) {
}
case class SubImage(profile: ImageProfile, offset: Int,
                    path: String) {
  val vPadding = 0
  val hPadding = 0
}
